...
<qgis version="2.12.0-Lyon" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 attr="LEGEND" forceraster="0" symbollevels="1" type="categorizedSymbol">
    <categories>
      ...
      <category render="true" symbol="3" value="Named road" label="Named road"/>
      <category render="true" symbol="4" value="Primary route" label="Primary route"/>
      <category render="true" symbol="5" value="Primary route B road" label="Primary route B road"/>
      <category render="true" symbol="6" value="Trunk road" label="Trunk road"/>
    </categories>
    <symbols>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="4">
        <layer pass="5" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="59,197,96,255"/>
          <prop k="line_style" v="solid"/>
