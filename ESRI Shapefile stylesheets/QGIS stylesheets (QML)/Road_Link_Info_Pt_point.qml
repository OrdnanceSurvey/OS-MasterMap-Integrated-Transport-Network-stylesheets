...
<qgis version="2.12.0-Lyon" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="REF_LINK">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
  ...
  <renderer-v2 attr="ENV_QUAL" forceraster="0" symbollevels="0" type="categorizedSymbol">
    <categories>
      ...
      <category render="true" symbol="2" value="Bridge Over Road" label="Bridge Over Road"/>
      <category render="true" symbol="3" value="Ford" label="Ford"/>
      <category render="true" symbol="4" value="Gate" label="Gate"/>
      <category render="true" symbol="5" value="Level Crossing" label="Level Crossing"/>
      <category render="true" symbol="6" value="Rising Bollards" label="Rising Bollards"/>
      <category render="true" symbol="7" value="Toll Indicator" label="Toll Indicator"/>
    </categories>
    <symbols>
